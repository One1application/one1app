...
export default function PaymentInterface() {
  ...
  useEffect(() => {
    if (location.state) {
      ...
      if (
        location.state.courseType === "telegram" &&
  ...
  const handlePayment = async () => {
    ...
    try {
        ...
        if (res.data.payload.paymentProvider === "Phonepay") {
          ...
          const options = {
            ...
            handler: function (response) {
              ...
              if (baseAmount)
                params.append("discountedPrice", baseAmount.toString());
      ...
      if (
        errorMessage.includes("Cannot purchase subscription") &&
        errorMessage.includes("within the last 5 days")
      ) {
            ...
            >
              ...
              <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 mt-auto">
                ...
                >
                  ...
                  {/* Right: Powered by Razorpay + PhonePe */}
                  <div className="flex items-center gap-1.5 bg-green-600 px-2.5 py-1 rounded-full text-[11px] text-white shadow-sm max-w-fit">
                    <span className="opacity-80 whitespace-nowrap">
                      powered by
                    </span>
                    <div className="flex items-center gap-1.5">
                      {/* Razorpay */}
                      <div className="w-6 h-6 flex items-center justify-center rounded-full bg-white p-0.5 shrink-0">
                        <svg
                          role="img"
                          viewBox="0 0 24 24"
