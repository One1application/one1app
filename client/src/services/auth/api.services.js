...
export const verifyEnteredOTP = async (data) => {
  const response = await servicesAxiosInstance.post('/auth/register/verify-otp', data);
  return response;
};
...
export const verifyLoginUser = async (data) => {
  const response = await servicesAxiosInstance.post('auth/login/verify-otp', data);
  return response;
};
...
export const updateBusinessInfo = async (data) => {
  const response = await servicesAxiosInstance.post('/wallet/update-business-info', data);
  return response;
};
...
export const updateVerificationInformation = async (data) => {
  const response = await servicesAxiosInstance.post('/wallet/update-verfication-details', data);
  return response;
};
...
export const updatePrimaryPaymentInformation = async (bankDetailsId, data) => {
  const response = await servicesAxiosInstance.post(`/wallet/update-bank-details/${bankDetailsId}`, data);
  return response;
};
...
export const deleteSecondaryBankorUpiAccount = async (data) => {
  const response = await servicesAxiosInstance.delete('/wallet/delete-bank-or-upi', { data });
  return response;
};
...
export const purchaseWebinar = async (data) => {
  const response = await servicesAxiosInstance.post('/webinar/purchase-webinar', data);
  return response;
};
...
export const purchaseCourse = async (data) => {
  const response = await servicesAxiosInstance.post('/course/purchase-course', data);
  return response;
};
...
export const purchasePayingUp = async (data) => {
  const response = await servicesAxiosInstance.post('/payingup/purchase-payingup', data);
  return response;
};
...
export const verifyInviteLink = async (inviteLink) => {
  const response = await axios.post(`${import.meta.env.VITE_BOT_SERVER_URL}/verify-channel`, {
    inviteLink,
  });
  return response;
};
...
export const deletePremiumContentById = async (contentId) => {
  try {
    const response = await servicesAxiosInstance.delete(`/premium/delete-premium-content/${contentId}`);
...
export const purchasePremiumContent = async (data) => {
  const response = await servicesAxiosInstance.post('/premium/purchase-premium-content', data);
  return response;
};
...
export const fetchFilterEarningsAndWithdrawals = async ({ fetchRange }) => {
  if (fetchRange.startsWith('CustomRange=')) {
    ...
    const response = await servicesAxiosInstance.get(`/wallet/withdrawal-earnings?${fetchRange}`);
    return response;
  } else {
    const response = await servicesAxiosInstance.get(`/wallet/withdrawal-earnings?${fetchRange}=true`);
    return response;
  }
};
...
export const sendTelegramLoginCode = async (phoneNumber) => {
  const response = await servicesAxiosInstance.post('/telegram/send-login-code', { phoneNumber });
  return response;
};
