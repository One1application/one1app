...
const TelegramsPages2 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-200  to-pink-500">
      {/* Header Section */}
      ...
      <div className="max-w-4xl mx-auto -mt-24 bg-slate-800 rounded-xl shadow-lg z-10 relative border border-gray-700">
        <div className="p-6">
          <div className="mb-4 flex justify-between">
             <div className="w-1/2">
              <label className="block text-sm font-medium text-orange-500 mb-4">
                Select Telegram Channel <span className="text-red-500">*</span>
              </label>
              <select
                className="w-full h-1/2 px-4 py-2 border border-orange-600 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-gray-900 text-white"
                value={genre}
                onChange={(e) => setGenre(e.target.value)}
              >
                <option value="futurecoders">Future Coders</option>
                <option value="jeeprep">JEE Preparation</option>
                <option value="market">Stock Market</option>
              </select>
              </div>
               {/* Cover Picture */}
              <div className="mb-8">
...
export default TelegramsPages2;
