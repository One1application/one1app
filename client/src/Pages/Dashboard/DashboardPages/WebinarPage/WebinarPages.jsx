...
<div className="w-full max-w-7xl mx-auto min-h-screen bg-black rounded-3xl overflow-hidden px-4 py-10 text-white">
   <PaymentSignUpModel
      ...
      <div className="bg-gradient-to-br from-orange-600/80 to-gray-900/60 rounded-3xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <h2 className="text-3xl font-semibold">{webinarData.createdBy.name}</h2>
          </div>
        </div>
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold">{webinarData.title}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
        <div>
          <h3 className="text-3xl font-semibold text-orange-600 mb-4">Cover Photo</h3>
          <img
        ...
        <div>
          <h3 className="text-3xl font-semibold text-orange-600 mb-4">Description</h3>
          <div className="bg-gray-900 p-6 rounded-3xl">
            <p className="text-lg leading-8">
             {webinarData.description ? webinarData.description : 'At OneApp, we are focused on elevating creators by offering a platform that makes the path from passion to profit effortless... ' }
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="mt-16">
        <h2 className="text-4xl font-semibold text-orange-600 mb-6">Class Information</h2>
  ...
  <div className="border-2 border-solid border-orange-300 rounded-xl p-4 mt-4 mb-4 space-y-4">
    <h3 className="text-2xl font-semibold text-orange-600">Date & Time</h3>
    <p className="text-lg">
  ...
  <div className="border-2 border-solid border-orange-300 rounded-2xl p-6 mt-6 mb-8 space-y-8">
    ...
    {webinarData.isOnline && webinarData.link.meetingLink && (
      <div className="space-y-4">
        <h3 className="text-3xl font-semibold text-orange-600">Zoom Meeting Link</h3>
        ...
        <h2 className="text-2xl font-semibold text-orange-600">Meeting Password:<span className="text-white font-semibold"> {webinarData.link.meetingPassword}</span></h2>
        <h2 className="text-2xl font-semibold text-orange-600">Meeting Id:<span className="text-white font-semibold">{webinarData.link.meetingId}</span> </h2>
      </div>
    )}
    ...
    {webinarData.isOnline && webinarData.link.platformLink && (
      <div className="space-y-4">
        <h3 className="text-3xl font-semibold text-orange-600">Google Meet Link</h3>
        <div className="flex items-center space-x-4">
          {/* <img
...
<rect width="10" height="16" x="12" y="16" fill="#fff" transform="rotate(-90 20 24)"></rect><polygon fill="#1e88e5" points="3,17 3,31 8,32 13,31 13,17 8,16"></polygon><path fill="#4caf50" d="M37,24v14c0,1.657-1.343,3-3,3H13l-1-5l1-5h14v-7l5-1L37,24z"></path><path fill="#fbc02d" d="M37,10v14H27v-7H13l-1-5l1-5h21C35.657,7,37,8.343,37,10z"></path><path fill="#1565c0" d="M13,31v10H6c-1.657,0-3-1.343-3-3v-7H13z"></path><polygon fill="#e53935" points="13,7 13,17 3,17"></polygon><polygon fill="#2e7d32" points="38,24 37,32.45 27,24 37,15.55"></polygon><path fill="#4caf50" d="M46,10.11v27.78c0,0.84-0.98,1.31-1.63,0.78L37,32.45v-16.9l7.37-6.22C45.02,8.8,46,9.27,46,10.11z"></path>
    ...
    {!webinarData.isOnline && webinarData.venue && (
      <div className="space-y-4">
        ...
        <p className="text-lg text-white font-bold">{webinarData.venue}</p></div>
      </div>
    )}
  </div>
)}
      ...
      {/* Ticket Information */}
      <section className="mt-16">
        <h2 className="text-4xl font-semibold text-orange-600 mb-6">Ticket Information</h2>
        <div className="bg-gray-900 p-6 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-6 border-2 border-solid border-orange-300 rounded-xl p-4 mt-4 mb-4">
          ...
          <div className="bg-gray-800 p-4 rounded-xl text-center">
            <h3 className="text-2xl font-semibold text-orange-600"> {webinarData.isPaid ? "Paid" : 'Free'}</h3>
      ...
      <div className="mt-16 flex justify-center">
        <button onClick={handlePayment} disabled={isVerifying || !webinarData.paymentEnabled} className="bg-orange-600 px-8 py-4 rounded-2xl text-white text-2xl font-semibold shadow-lg">
